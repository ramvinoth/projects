...
<span style='font-size:18px;'>VIYA</span> - Daily Catch-Up Alert
</td>
</tr>
<tr>
...
//			    
                            if (@$findEmail['User']['id']) {
                                $subject = $fromName . " invited you to join " . CMP_SITE . " on VIYA Clound Project Management Platform";
                                $ext_user = 1;
                            } else {
                                $subject = $fromName . " invited you to join VIYA Projects";
                            }
