...
define("SMTP_UNAME", "ramvinoth37@gmail.com");
define("SMTP_PWORD", "");
//https://www.arclab.com/en/amlc/list-of-smtp-and-imap-servers-mailserver-list.html (Get the list of Host names)
*/
//Gmail SMTP
define("SMTP_HOST", "mail.viya.biz");
define("SMTP_PORT", "25");
define("SMTP_UNAME", "notification@viya.biz");
define("SMTP_PWORD", "viyaSmart$6");
//https://www.arclab.com/en/amlc/list-of-smtp-and-imap-servers-mailserver-list.html (Get the list of Host names)
...
########################################################################
define("WEB_DOMAIN", "viya.biz"); //ex. demo.orangescrum.com
define('FROM_EMAIL_NOTIFY', 'notification@viya.biz'); //(REQUIRED)
define('SUPPORT_EMAIL', 'support@viya.biz'); //(REQUIRED) From Email
define('FROM_EMAIL',  'VIYA<'.SUPPORT_EMAIL.'>');

define("DEV_EMAIL", 'ramvinoth37@gmail.com'); // Developer Email ID to report the application error
define('EMAIL_SUBJ', '[VIYA]');
...
define('SUB_FOLDER', 'projects/'); //If your application URL followed by a folder name like: http://your-site.com/folder_name, put your folder name as 'folder_name/'

if(php_sapi_name() === "cli") {
	define('PROTOCOL', "http://");
	define('DOMAIN', "www.viyabiz/"); // Please set your application domain (REQUIRED)
}else{
