...
<div class="steps_os">
	<div class="steps_usr">
		<h1 style="color: #428BCA;">Welcome <?php echo USERNAME; ?>!<br/> Get started with your VIYA account</h1>
		<h6 style="color: #D67866;font-size: 17px;">You're just 3 simple steps away from exploring VIYA!</h6>
	</div>
		...
		<tr>
				...
				<table class="onbrd_lt_tbl">
					<tr>
						...
						<td class="<?php if($is_active_proj){?>inactive_ttl<?php }else{?>active_ttl <?php }?>">
							<h4>Create and Assign Project</h4>
							<div class="det_text">
					...
					<tr>
						...
						<td class="<?php if($totalusers>1){?>inactive_ttl<?php }else{?>active_ttl <?php }?>">
							<div id="InvitedUserWithoutLnk" <?php if($totalusers<=1){ ?> onmouseover="showInvitedUserLnk('InvitedUserWithoutLnk','InvitedUserLnk');" <?php } ?> ><h4>Invite User</h4></div>
							<div id="InvitedUserLnk" style="display:none;"><a href="javascript:void(0);" <?php if(ACCOUNT_STATUS!=2){?> onclick="newUser('menuid1','loaderid1');" <?php }?> style="text-decoration: underline;" onmouseout="hideInvitedUserLnk('InvitedUserWithoutLnk','InvitedUserLnk');"><h4>Invite User</h4></a></div>
							<div class="det_text">
								<ul style="list-style: square;">
					...
					<tr>
						...
						<td class="<?php if(isset($task_crted) && $task_crted>=1){?>inactive_ttl<?php }else{?>active_ttl <?php }?>">
							<div id="CreateTaskWithoutLnk" <?php if((!isset($task_crted)) || ($task_crted==0)){ ?> onmouseover="showInvitedUserLnk('CreateTaskWithoutLnk','CreateTaskLnk');"<?php } ?> ><h4>Create Task</h4></div>
							<div id="CreateTaskLnk" style="display:none;"><a href="javascript:void(0);" onclick="open_new_case();" style="text-decoration: underline;" onmouseout="hideInvitedUserLnk('CreateTaskWithoutLnk','CreateTaskLnk');"><h4>Create Task</h4></a></div>
							<div class="det_text">
								<ul style="list-style: square;">
			...
			<td class="onbrd_rt">
				...
				<?php }elseif($totalusers<=1){?>
					...
					VIYA works best when you add your Co-workers.</h4>
				...
				<?php }else{ $autorefreshflag =1;?>
						<h4 style="text-shadow:none; font-size: 26px;text-align:center">Wow! You have completed all the basics of VIYA.<br/>
						Now you can get started with VIYA.</h4><br/>
						<h6>
